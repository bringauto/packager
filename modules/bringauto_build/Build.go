...
func (build *Build) RunBuild() error {
	...
	packBuildChainLogger := logger.CreatePackageContextLogger(build.Package.CreatePackageName(true), bringauto_log.BuildChainContext)
...
func (build *Build) downloadInstalledFiles() error {
	...
	packTarLogger := bringauto_log.GetLogger().CreatePackageContextLogger(build.Package.CreatePackageName(true), bringauto_log.TarContext)
